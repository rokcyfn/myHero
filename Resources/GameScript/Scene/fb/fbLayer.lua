...
function M:createCell( params )
  ...
  local sprintBtn = Btn:new( IMG_BTN , { "sprint.png", "sprint_pre.png"}, 272, 12, { 
    callback = function()
        ...
        HTTPS:send("Duplicate", {duplicate  = "emigrated", a = "duplicate", m = "duplicate"}, {success_callback = function(data)
            local scene = display.getRunningScene()
            tower = display.newSprite( PATH .. "tower_" .. data.type_id .. ".png"  , display.cx , display.cy , 0.5 , 0.5 )
